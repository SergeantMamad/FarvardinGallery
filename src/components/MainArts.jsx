  ...
  return (
    <div className="relative">
      <svg
        ...
        stroke="currentColor"
        onClick={() => scrollLeft()}
        className="w-12 h-12 absolute -left-6 z-10 top-1/3 bg-emerald-500 p-2 rounded-full cursor-pointer"
      >
        <path
          strokeLinecap="round"
      ...
      <svg
        ...
        stroke="currentColor"
        onClick={() => scrollRight()}
        className="w-12 h-12 absolute top-1/3 z-10 -right-7 bg-emerald-500 p-2 rounded-full cursor-pointer"
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
      ...
      >
        {Object.keys(mainArtsObj).map((index) => (
          <div className="min-w-[350px] bg-zinc-100 rounded-lg">
